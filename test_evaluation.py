...
ADAPTER_PATH = "./deberta_mitre_adapter" # Directory where trainer.save_model() saved the LoRA adapter
TEST_DATA_FILE = "test.csv" # *** CRITICAL: Ensure this is a new, unseen dataset ***
...
# The Trainer's evaluate method handles the loop and metric calculation
...
print("----------------------------------")
print(f"Evaluation complete. Results saved to {RESULT_OUTPUT_DIR}")